package mjthornton.com.interior
...
import mjthornton.com.interior.adapters.FurnitureAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    // Holds all of the furniture items
    private var furniture = arrayListOf<Uri>(
        Uri.parse("NOVELO_EARTH.sfb"),
        Uri.parse("Sofa.sfb"),
        Uri.parse("DesignChair1.sfb")
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvItems.adapter = FurnitureAdapter(furniture, this)

        // Set the onclick lister for our button
        // Change this string to point to the .sfb file of your choice :)
        floatingActionButton.setOnClickListener { addObject(Uri.parse("Center Table.sfb")) }
        showFab(true)
    }
